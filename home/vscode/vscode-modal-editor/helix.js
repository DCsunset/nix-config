...
module.exports = {
	...
	normal: {
		...
		j: repeatable(reselect("cursorLeft")),
		k: repeatable(reselect("cursorDown")),
		l: repeatable(reselect("cursorUp")),
		";": repeatable(reselect("cursorRight")),
	...
	select: {
		...
		k: repeatable("cursorDownSelect"),
		l: repeatable("cursorUpSelect"),
